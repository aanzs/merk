        ...
        <div class="container">
            ...
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="form-group">
                    <label>ID MERK</label>
                    <input class="form-control" type="number" name="id_merk" placeholder="ID MERK">
                </div>
                <div class="form-group">
                ...
                <?php
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while($row = mysqli_fetch_assoc($result)) { ?>
                            ...
                            <a class="btn btn-danger btn-sm" href='edit.php?id_merk=<?php echo $row["id_merk"]; ?>'>EDIT</a>
                            <a class="btn btn-warning btn-sm" href='hapusDataSiswa.php?id_merk=<?php echo $row["id_merk"]; ?>'>HAPUS</a></td></tr>
                        <?php }
                    } else { ?>
